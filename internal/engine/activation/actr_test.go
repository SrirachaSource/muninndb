...
func TestComputeACTR_FreshEngram(t *testing.T) {
	...
	contentMatch := 0.35*0.9 + 0.25*normalizeFTS(2.0)
	...
	assertNear(t, "FullTextRelevance", sc.FullTextRelevance, normalizeFTS(2.0), 1e-9)
	if sc.Raw < 0.3 {
...
func TestComputeACTR_OldEngram_NoHebbian(t *testing.T) {
	...
	contentMatch := 0.35*0.7 + 0.25*normalizeFTS(1.0)
	n := 1.0
...
func TestComputeACTR_HighAccessCount(t *testing.T) {
	...
	contentMatch := 0.35*0.7 + 0.25*normalizeFTS(1.5)
	n := 101.0
...
func TestComputeACTR_ScoreClamping(t *testing.T) {
	...
	contentMatch := 0.35*1.0 + 0.25*normalizeFTS(10.0)
	n := 51.0
...
func TestComputeACTR_ZeroLastAccess(t *testing.T) {
	...
	contentMatch := 0.35*0.8 + 0.25*normalizeFTS(1.0)
	n := 1.0
...
func TestComputeACTR_FreshVault_Differentiated(t *testing.T) {
	...
	contentHigh := w.SemanticSimilarity*0.9 + w.FullTextRelevance*normalizeFTS(1.0)
	contentLow := w.SemanticSimilarity*0.4 + w.FullTextRelevance*normalizeFTS(1.0)
