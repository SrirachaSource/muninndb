...
func (e *slowIdempotentEngine) Evolve(ctx context.Context, vault, oldID, newContent, reason, concept string, embedding []float32) (*WriteResult, error) {
	return (&fakeEngine{}).Evolve(ctx, vault, oldID, newContent, reason, concept, embedding)
}
